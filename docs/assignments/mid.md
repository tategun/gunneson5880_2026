...
<div class='tableauPlaceholder' id='viz1778265377805' style='position: relative'>
  <noscript>
    <a href='#'>
      <img alt='Average Income Per Capita Iowa By Year'
           src='https://public.tableau.com/static/images/Mi/MiniProject_17781082909810/Story1/1_rss.png'
           style='border: none' />
    </a>
  </noscript>
  <object class='tableauViz' style='display:none;'>
    ...
    <param name='name' value='MiniProject_17781082909810/Story1' />
    <param name='tabs' value='no' />
    <param name='toolbar' value='yes' />
    <param name='static_image' value='https://public.tableau.com/static/images/Mi/MiniProject_17781082909810/Story1/1.png' />
